package com.raminq.httpclientinjava11;
 ...
 * <code>docker run -p 8001:80 kennethreitz/httpbin</code>
 */
...
public class TestNewHttpClient {
    ...
    public void testPostFormWithBody() throws IOException, InterruptedException {
        ...
        HttpRequest request = HttpRequest.newBuilder()
                .timeout(Duration.ofSeconds(240))
                .uri(URI.create(BASE_URL + "/post"))
                .POST(HttpRequest.BodyPublishers.ofString("firstName=Ramin&lastName=q"))
        ...
        Assert.assertEquals("q", formData.get("lastName"));
    }
